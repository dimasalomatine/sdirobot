...
class Common {
    ...
    /*
     public static boolean emptyString_old(String s) {
     if (s == null) {
     return true;
     } else if (s.equals("")) {
     return true;
    ...
    /*
     public static String changeExtension_old(String fn, String ext) {
    ...
    public static void debugingLine2D(String s) {
        setDebugingLine(s, "evlog", System.getProperty("user.dir"));
    }
    ...
    public static void setDebugingLine(String s, String appworkingdir) {
        ...
        try {
            ...
            String fp = appworkingdir + "\\ServerLog\\current.log";

            File f = new File(fp);
            if (f.exists()) {
                if (f.length() > 1000000) {
                    String fp1 = appworkingdir + "\\ServerLog\\" + fn + " " + dt.substring(4, 11).replaceAll(" ", "") + ".log";
                    File f1 = new File(fp1);
                    if (!f.renameTo(f1)) {
                        System.out.println("Cant rename:" + fp + " to:" + fp1);
                    }
